        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <!-- Attachments -->
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8" x-data="{ 
                        downloading: false,
                        files: [
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            ...
                            @if($complaint->attachments->count() > 1)
                                <button @click="downloadAll" :disabled="downloading" class="inline-flex items-center justify-center px-5 py-2.5 bg-orange-600 text-white rounded-xl text-xs font-bold hover:bg-orange-700 transition-all shadow-sm hover:shadow-md disabled:opacity-50 active:scale-95">
                                    <template x-if="!downloading">
                                        <div class="flex items-center">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                            Unduh Semua ({{ $complaint->attachments->count() }})
                                        </div>
                                    </template>
                                    <template x-if="downloading">
                                        <div class="flex items-center">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            @forelse ($complaint->attachments as $attachment)
                                ...
                                @endphp
                                <div class="group relative bg-gray-50 rounded-xl border border-gray-100 hover:border-orange-200 transition-all overflow-hidden">
                                    <div class="flex items-center p-4">
                                        <a href="{{ $previewUrl }}" target="_blank" class="flex items-center flex-1 overflow-hidden">
                                            ...
                                            <div class="overflow-hidden">
                                                <p class="text-sm font-bold text-gray-900 truncate pr-2">{{ $attachment->original_name }}</p>
                                                <p class="text-xs text-gray-500 uppercase">{{ $attachment->attachment_type }}</p>
                                            </div>
                                        </a>
                                        <a href="{{ $downloadUrl }}" class="p-2 text-gray-400 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-all" title="Unduh File">
